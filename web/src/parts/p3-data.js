...
const VERSIONES = [
  { v: '0.33', f: '26 de septiembre de 2026', t: 'La línea entera, a cuatro voces',
    c: [
      ...
      'Con ellas, <b>las sesenta y una entradas están escritas cuatro veces cada una</b>: la técnica, la sobria, la microhistoria y la escena. Dos mil seiscientas palabras nuevas, y ningún dato que no estuviera ya en la fuente.',
      'La era del ayuntamiento quedó votada en once entradas y con cinco empates a dos corazones; esas cinco vuelven a preguntarse solas, sin repetir lo demás.',
      '<b>En la línea no cambia nada hasta que se vote</b>, igual que en las eras anteriores.'
    ],
    p: 'Cinco eras, sesenta y una entradas y cuatro redacciones de cada una: ya no falta ninguna por comparar.' },
